...
## running code
# Server 만들기
1. GPU T4 1개, 3 core memory 15.8G 환경의 Virtual Machine instance 만들기
2. requirements에 필요한 install 다운로드
3. conda install ffmpeg
4. 모든 python file import
5. uvicorn server:app --reload --host=x.x.x.x --port=x 명령어 실행
